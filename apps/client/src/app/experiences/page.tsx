...
const COLLECTIONS = [
    { title: "Avistamiento de Fauna", icon: Binoculars, color: "from-emerald-500 to-green-600", image: "/images/collection-fauna.jpg" },
    { title: "Fotografía Salvaje", icon: Camera, color: "from-sky-500 to-blue-600", image: "/images/collection-wildlife.jpg" },
